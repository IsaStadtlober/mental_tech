...
import type { EducatorDashboardScreenProps } from "@/types/professor/dashboard";
      ...
      >
          ...
          >
            ...
            >
              <AppButton
                ...
                iconLeft={
                  <Plus size={18} strokeWidth={2.4} color={theme.white} />
                }
                accessibilityHint={
                  PROFESSOR_DASHBOARD_MESSAGES.overview
                    .newMissionAccessibilityHint
                }
              />
            </View>
          </View>
        ...
        <View style={[educatorStyles.metricsGrid, { marginTop: 16 }]}>
          <MetricCard
            label={
              PROFESSOR_DASHBOARD_MESSAGES?.priorities?.metrics
                ?.waitingCorrection?.label ?? "Aguardando correção"
            }
          ...
          <MetricCard
            label={
              PROFESSOR_DASHBOARD_MESSAGES?.priorities?.metrics
                ?.publishedActivities?.label ?? "Publicadas"
            }
          ...
          <View style={educatorStyles.mainColumn}>
            <AppCard>
              <SectionHeader
                ...
                subtitle={PROFESSOR_DASHBOARD_MESSAGES.studentsInFocus.subtitle}
          ...
          <View style={educatorStyles.sideColumn}>
            <AppCard>
              ...
              <View style={{ gap: 10 }}>
                ...
                <AppButton
                  label={
                    PROFESSOR_DASHBOARD_MESSAGES.quickActions.manageActivities
                  }
                  onPress={onOpenActivities}
                  variant="secondary"
                  fullWidth
                ...
                <AppButton
                  label={
                    PROFESSOR_DASHBOARD_MESSAGES.quickActions.consultReports
                  }
                  onPress={onOpenReports}
                  variant="ghost"
                  fullWidth
        ...
        <View style={educatorStyles.section}>
          <AppCard>
            <SectionHeader
              ...
              subtitle={PROFESSOR_DASHBOARD_MESSAGES.recentSubmissions.subtitle}
              style={educatorStyles.panelHeaderSpacing}
              action={
                <AppButton
                  label={
