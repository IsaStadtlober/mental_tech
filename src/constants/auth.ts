...
export const STUDENT_AUTH_CONSTANTS = {
  ...
  TEXTS: {
    ...
    NAME_TITLE: "Código de acesso do aluno",
    NAME_SUBTITLE: "Insira o código que foi enviado pela escola ao responsável.",
...
export const EDUCATOR_AUTH_CONSTANTS = {
  ...
  PLACEHOLDERS: {
    ...
    POSITION: "Ex: Professor de Matemática",
    REGISTRATION_NUMBER: "Ex: 123456",
